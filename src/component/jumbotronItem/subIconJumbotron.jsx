...
const SubIcon = ({icon,textIcon})=>{
  return (
    <div className="icon-travel w-[auto] h-[80px]">
...
const SubIconJumbotron = ()=>{
    return (
      <section className="container-icon  mx-auto max-w-md mt-7 flex justify-center gap-2 items-center  flex-wrap max-[315px]:gap-y-5">
